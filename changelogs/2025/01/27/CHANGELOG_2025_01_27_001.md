...
```bash
curl http://localhost:9999  # Returns empty response (expected for this proxy)
```

#### Notes
- CORS proxy must be started with `cors-proxy start -p 9999` command
- Can be stopped with `cors-proxy stop`
